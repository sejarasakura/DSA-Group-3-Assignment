...
import adt.ArrList;
import cilent.pages.AbstractPage;
 ...
 */
public class EditAdminBAckUp extends AbstractPage {
    ...
    public EditAdminBAckUp(HttpServletRequest request) {
        super(request);
        ...
        try {
            ...
            Gson gson = new Gson();
            map = gson.fromJson(reader, WebConfig.WRITING_CLASS);
