...
public class TestSortListSlotAlgorithmSpeedsSmall {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options opt = new OptionsBuilder()
                .include(TestSortListSlotAlgorithmSpeedsSmall.class.getSimpleName())
                .forks(1)
                .build();
    ...
    static int[] createArrayWithRandomInts(int size) {
        ...
        for (int i = 0; i < size; i++) {
            array[i] = (int) (Math.random() * Math.random() * 1000);
        }
        return array;
    }
