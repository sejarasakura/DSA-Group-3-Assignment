...
<%-- import css lib--%>
<link href="<%= getServletContext().getInitParameter("DomainName")%>theme/lib/bootstrap/css/bootstrap.min.css"
      rel="stylesheet"/>
<link href="<%= getServletContext().getInitParameter("DomainName")%>theme/lib/datatable/datatables.min_1.css"
      rel="stylesheet"/>
<link href="<%= getServletContext().getInitParameter("DomainName")%>theme/lib/datatable/datatables.min_1.css"
      rel="stylesheet"/>
