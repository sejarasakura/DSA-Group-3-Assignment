...
<html>
    ...
    <body>
        ...
        <form method="post" onsubmit="">
            <input type="text" class="form-control" id="form-latlng" name="form-latlng" value="null"/>
            <input type="text" class="form-control" id="to-latlng" name="to-latlng" value="null"/>
